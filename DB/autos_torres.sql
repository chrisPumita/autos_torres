...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2021 a las 23:56:04
...
(3, 150, '2021-03-24 00:00:00', 2018, 'CTF9005', 'DF', 'Rojo', 620000, 'MA', 'GASOLINA', 4, '100000.00', '150000.00', 1, 'Vender en corto', 1),
(1234, 186, '2021-02-28 21:29:34', 2001, 'MKH7443', 'MEX', 'Rojo', 1004504, 'AU', 'GASOLINA', 5, '150000.00', '200000.00', 1, 'SIN PB', 1),
(4353, 3, '2021-02-28 21:29:34', 2001, 'MKH7443', 'MEX', 'Rojo', 1004504, 'AU', 'GASOLINA', 5, '150000.00', '200000.00', 1, 'SIN PB', 1);
...
(3, 1, 1234, 'FOTO DE PERFIL', 'https://static2.abc.es/media/summum/2019/12/08/lamborghini-abandonado-krdB--620x349@abc.jpg', 'jpg', 0, 1);
...
--
ALTER TABLE `file_vechiculo`
  MODIFY `id_file_v` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
